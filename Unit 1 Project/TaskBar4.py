...
def popupwindow(*args):
  ...
  if data[3] <= 20:
    eventcanvas[len(eventcanvas)-1].config(bg="#00ff37")
    eventlabel[len(timeanddatelabel) - 1].config(bg="#00ff37")
    timeanddatelabel[len(timeanddatelabel) - 1].config(bg="#00ff37")
    timeneededlabel[len(timeanddatelabel) - 1].config(bg="#00ff37")
  if data[3] <= 50 and data[3] > 20:
    eventcanvas[len(eventcanvas)-1].config(bg="yellow") 
    eventlabel[len(timeanddatelabel) - 1].config(bg="yellow")
    timeanddatelabel[len(timeanddatelabel) - 1].config(bg="yellow")
    timeneededlabel[len(timeanddatelabel) - 1].config(bg="yellow") 
  
  if data[3] > 50:
    eventcanvas[len(eventcanvas)-1].config(bg="red")
    eventlabel[len(timeanddatelabel) - 1].config(bg="red")
    timeanddatelabel[len(timeanddatelabel) - 1].config(bg="red")
    timeneededlabel[len(timeanddatelabel) - 1].config(bg="red") 
